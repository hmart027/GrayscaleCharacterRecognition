...
public class ANNSettingsTab extends JPanel{
	...
	public void setGCRHandler(GCRHandler h){
		...
		hiddenSize.setText(h.ann.hiddenLayerSize+"");
		outputSize.setText(h.ann.outLayerSize+"");
		
		learnigRateField.setText(h.ann.learningRate+"");
		momentumField.setText(h.ann.momentum+"");
		maxErrorField.setText(h.ann.maxError+"");
